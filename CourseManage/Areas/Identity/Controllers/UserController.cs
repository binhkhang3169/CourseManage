...
using Course.Web.Areas.Identity.Controllers;
using CourseManage.Areas.Identity.Controllers;
using CourseManage.Areas.Identity.Models.UserViewModels;
using CourseManage.Data;
using CourseManage.Entities;
using CourseManage.ExtendMethods;
...
namespace CourseManage.Areas.Identity.Controllers
{
